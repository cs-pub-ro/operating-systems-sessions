...
That question is exactly what gdb and Valgrind are built to help you answer, which is why learning to reach for them automatically — not just after something visibly breaks — is the actual skill this session is trying to teach.
