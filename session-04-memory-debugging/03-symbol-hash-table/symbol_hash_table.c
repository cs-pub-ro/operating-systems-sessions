/*
 * symbol_hash_table.c -- separate-chaining hash table implementation.
 *
 * This file contains THREE memory bugs, planted on purpose. The program
 * builds cleanly with -Wall -Wextra, and the numbers it prints often look
 * plausible. Your job is to find the bugs using manual inspection, gdb and
 * Valgrind -- see README.md for the debugging workflow and hints.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
		   ...
		   void *address, sym_region_t region)
{
	...
	/* Link the new node in at the head of its bucket. */
