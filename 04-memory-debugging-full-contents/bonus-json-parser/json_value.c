/*
 * json_value.c -- reference implementation (no known bugs).
 *
 * A small recursive-descent JSON parser plus a serializer/printer, built
 * around json_value_t from json_value.h.
 */
#include <ctype.h>
#include <stdio.h>
#include <stdlib.h>
